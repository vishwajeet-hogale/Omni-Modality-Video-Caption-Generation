...
class StandardTemporalEvaluator:
    ...
    def run_standard_evaluation(self):
        ...
        print("="*60)
        print("Testing 4 temporal window configurations with LoRA:")
        print("- Ultra-short: 3 frames (0.1s)")
        print("- Very-short: 5 frames (0.17s)")
        print("- Short: 10 frames (0.33s)")
        print("- Medium: 16 frames (0.53s)")
